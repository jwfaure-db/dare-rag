...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-josh_faure` from the dropdown menu ([open cluster configuration](https://dbc-967c02c1-b6af.cloud.databricks.com/#setting/clusters/1211-002634-36a1odp/configuration)). <br />
...
dbutils.widgets.text("endpoint", f"{catalog}_{db}_endpoint"[:63], label = "Name of Model Serving Endpoint")
...
dbutils.widgets.text("checkpoint_location", f'dbfs:/Volumes/{catalog}/{db}/jf_test/checkpoints/payload_metrics', label = "Checkpoint Location")
